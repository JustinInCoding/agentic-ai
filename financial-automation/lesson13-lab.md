...
```text
https://github.com/DjangoPeng/agentic-ai
```

本节课程代码位于仓库的 `financial-automation/` 子目录：

```text
https://github.com/DjangoPeng/agentic-ai/tree/main/financial-automation
```
...
仓库地址：https://github.com/DjangoPeng/agentic-ai
本节代码在仓库的 financial-automation/ 子目录

要求：
1. clone 完整仓库到 ~/projects/agentic-ai
2. 项目部署目录使用 ~/projects/financial-automation（软链接到仓库子目录）
...
git clone https://github.com/DjangoPeng/agentic-ai ~/projects/agentic-ai
ln -sfn ~/projects/agentic-ai/financial-automation ~/projects/financial-automation
cd ~/projects/financial-automation
python3 -m venv .venv
source .venv/bin/activate
...
```text
请把 ~/projects/financial-automation/.env 配成下面这样：
...
执行：
cd ~/projects/financial-automation
export FINANCIAL_AUTOMATION_ROOT=~/projects/financial-automation
...
1. `~/projects/financial-automation` 已存在
2. `.venv` 已创建
